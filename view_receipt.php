...
<div style="background:white;" class="container-fluid">
    <div id="outprint_receipt">
        ...
        <a href="index.html" class="logo me-auto me-lg-0"><img src="images/logo.jpg" alt="" class="img-fluid" id="logosize1"></a>
            <span>Sweet Shop Management System</span><br>
            <small>Receipt</small>
        </div>
        ...
        <div class="fs-6 fs-light d-flex w-100 mb-1">
            <span class="col-auto pe-2">Payment Method</span> 
            <span class="border-bottom border-dark flex-grow-1"><?php echo strtoupper($payment_method) ?></span>
        </div>
        <table class="table table-striped">
            ...
            <tfoot>
                <tr>
                    <th class="px-1 py-0" colspan="2">Total(Inclusive of GST.)</th>
                    <th class="px-1 py-0 text-end"><?php echo $total ?></th>
                </tr>
                <?php if($payment_method =='cash') {?>
                <tr>
                    <th class="px-1 py-0" colspan="2">Tendered Amount</th>
                    <th class="px-1 py-0 text-end"><?php echo $tendered_amount ?></th>
                </tr>
                <tr>
                    <th class="px-1 py-0" colspan="2">Change</th>
                    <th class="px-1 py-0 text-end"><?php echo format_num($change,2) ?></th>
                </tr>
                <?php }?>
            </tfoot>
        </table>
