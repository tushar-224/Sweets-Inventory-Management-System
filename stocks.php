        ...
        <table class="table table-hover table-striped table-bordered" id="table">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Stock Status</th>
            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td class="py-0 px-1 text-center"><?php echo strtotime(date("Y-m-d")) > strtotime($row['expiry_date']) ? '<span class="badge rounded-pill bg-danger">Expired</span>' : '<span class="badge rounded-pill bg-success">Available</span>' ?></td>
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle btn-sm py-0" data-bs-toggle="dropdown" aria-expanded="false">
                            Action
                            </button>
